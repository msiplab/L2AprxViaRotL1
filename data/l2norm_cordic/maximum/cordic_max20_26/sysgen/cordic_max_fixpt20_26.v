...
// Generated from Simulink block cordic_max_fixpt20_26/total26/Subsystem20bit
module cordic_max_fixpt20_26_subsystem20bit (
  ...
  assign ce_net = ce_1;
  xlcordic_acc004f7096e9851e9644d59588f97e0 cordic16 (
  ...
  sysgen_constant_e555180f4a constant (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .op(constant_op_net)
  );
  cordic_max_fixpt20_26_xlmult #(
    .a_arith(`xlSigned),
    .a_bin_pt(18),
    .a_width(20),
    .b_arith(`xlSigned),
    ...
    .c_output_width(40),
    .c_type(0),
    .core_name0("cordic_max_fixpt20_26_mult_gen_v12_0_i0"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_max_fixpt20_26_xladdsub #(
    .a_arith(`xlSigned),
    .a_bin_pt(36),
    .a_width(40),
    .b_arith(`xlSigned),
    ...
    .c_latency(0),
    .c_output_width(41),
    .core_name0("cordic_max_fixpt20_26_c_addsub_v12_0_i0"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(41),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_max_fixpt20_26/total26/Subsystem21bit
module cordic_max_fixpt20_26_subsystem21bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_9540a3a9c95746b7e874db85af4062f4 cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_max_fixpt20_26_xlmult #(
    ...
    .c_output_width(42),
    .c_type(0),
    .core_name0("cordic_max_fixpt20_26_mult_gen_v12_0_i1"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_max_fixpt20_26_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(43),
    .core_name0("cordic_max_fixpt20_26_c_addsub_v12_0_i1"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(43),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_max_fixpt20_26/total26/Subsystem22bit
module cordic_max_fixpt20_26_subsystem22bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_0dd6b238e6109774a17ed624c40db3d5 cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_max_fixpt20_26_xlmult #(
    ...
    .c_output_width(44),
    .c_type(0),
    .core_name0("cordic_max_fixpt20_26_mult_gen_v12_0_i2"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_max_fixpt20_26_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(45),
    .core_name0("cordic_max_fixpt20_26_c_addsub_v12_0_i2"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(45),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_max_fixpt20_26/total26/Subsystem23bit
module cordic_max_fixpt20_26_subsystem23bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_e3be0808725834a5633af98f6eca0683 cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_max_fixpt20_26_xlmult #(
    ...
    .c_output_width(46),
    .c_type(0),
    .core_name0("cordic_max_fixpt20_26_mult_gen_v12_0_i3"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_max_fixpt20_26_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(47),
    .core_name0("cordic_max_fixpt20_26_c_addsub_v12_0_i3"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(47),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_max_fixpt20_26/total26/Subsystem24bit
module cordic_max_fixpt20_26_subsystem24bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_556af209bc197dea814a36a57174b4b5 cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_max_fixpt20_26_xlmult #(
    ...
    .c_output_width(48),
    .c_type(0),
    .core_name0("cordic_max_fixpt20_26_mult_gen_v12_0_i4"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_max_fixpt20_26_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(49),
    .core_name0("cordic_max_fixpt20_26_c_addsub_v12_0_i4"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(49),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_max_fixpt20_26/total26/Subsystem25bit
module cordic_max_fixpt20_26_subsystem25bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_99f44845cff2412747a3cfb422e84e09 cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_max_fixpt20_26_xlmult #(
    ...
    .c_output_width(50),
    .c_type(0),
    .core_name0("cordic_max_fixpt20_26_mult_gen_v12_0_i5"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_max_fixpt20_26_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(51),
    .core_name0("cordic_max_fixpt20_26_c_addsub_v12_0_i5"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(51),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_max_fixpt20_26/total26/Subsystem26bit
module cordic_max_fixpt20_26_subsystem26bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_ecbc427b58ef955ff9265dbdd595464a cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_max_fixpt20_26_xlmult #(
    ...
    .c_output_width(52),
    .c_type(0),
    .core_name0("cordic_max_fixpt20_26_mult_gen_v12_0_i6"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_max_fixpt20_26_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(53),
    .core_name0("cordic_max_fixpt20_26_c_addsub_v12_0_i6"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(53),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_max_fixpt20_26/total26
module cordic_max_fixpt20_26_total26 (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  cordic_max_fixpt20_26_subsystem20bit subsystem20bit (
  ...
  cordic_max_fixpt20_26_subsystem21bit subsystem21bit (
  ...
  cordic_max_fixpt20_26_subsystem22bit subsystem22bit (
  ...
  cordic_max_fixpt20_26_subsystem23bit subsystem23bit (
  ...
  cordic_max_fixpt20_26_subsystem24bit subsystem24bit (
  ...
  cordic_max_fixpt20_26_subsystem25bit subsystem25bit (
  ...
  cordic_max_fixpt20_26_subsystem26bit subsystem26bit (
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_max_fixpt20_26_struct
module cordic_max_fixpt20_26_struct (
  input [20-1:0] gate_in1,
  input [20-1:0] gate_in2,
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  cordic_max_fixpt20_26_total26 total26 (
...
module cordic_max_fixpt20_26_default_clock_driver (
  input cordic_max_fixpt20_26_sysclk,
  input cordic_max_fixpt20_26_sysce,
  input cordic_max_fixpt20_26_sysclr,
  output cordic_max_fixpt20_26_clk1,
  output cordic_max_fixpt20_26_ce1
);
  xlclockdriver #(
    .period(1),
    .log_2_period(1)
  ...
  clockdriver (
    .sysclk(cordic_max_fixpt20_26_sysclk),
    .sysce(cordic_max_fixpt20_26_sysce),
    .sysclr(cordic_max_fixpt20_26_sysclr),
    .clk(cordic_max_fixpt20_26_clk1),
    .ce(cordic_max_fixpt20_26_ce1)
  );
endmodule
`timescale 1 ns / 10 ps
// Generated from Simulink block 
(* core_generation_info = "cordic_max_fixpt20_26,sysgen_core_2022_1,{,compilation=HDL Netlist,block_icon_display=Default,family=virtexuplus,part=xcu250,speed=-2L-e,package=figd2104,synthesis_language=verilog,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=50,system_simulink_period=1,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=126,addsub=7,constant=7,cordic_v6_0=7,mult=14,}" *)
module cordic_max_fixpt20_26 (
  ...
  wire ce_1_net;
  wire clk_1_net;
  cordic_max_fixpt20_26_default_clock_driver cordic_max_fixpt20_26_default_clock_driver (
    .cordic_max_fixpt20_26_sysclk(clk),
    .cordic_max_fixpt20_26_sysce(1'b1),
    .cordic_max_fixpt20_26_sysclr(1'b0),
    .cordic_max_fixpt20_26_clk1(clk_1_net),
    .cordic_max_fixpt20_26_ce1(ce_1_net)
  );
  cordic_max_fixpt20_26_struct cordic_max_fixpt20_26_struct (
