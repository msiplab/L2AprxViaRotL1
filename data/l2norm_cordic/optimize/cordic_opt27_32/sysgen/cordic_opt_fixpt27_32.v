...
// Generated from Simulink block cordic_opt_fixpt27_32/total32/Subsystem27bit
module cordic_opt_fixpt27_32_subsystem27bit (
  ...
  assign ce_net = ce_1;
  xlcordic_c20e97b4ce3c90db2366596eed1dfe33 cordic16 (
  ...
  sysgen_constant_de729eadb6 constant (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .op(constant_op_net)
  );
  cordic_opt_fixpt27_32_xlmult #(
    .a_arith(`xlSigned),
    .a_bin_pt(25),
    .a_width(27),
    .b_arith(`xlSigned),
    ...
    .c_output_width(54),
    .c_type(0),
    .core_name0("cordic_opt_fixpt27_32_mult_gen_v12_0_i0"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_opt_fixpt27_32_xladdsub #(
    .a_arith(`xlSigned),
    .a_bin_pt(50),
    .a_width(54),
    .b_arith(`xlSigned),
    ...
    .c_latency(0),
    .c_output_width(55),
    .core_name0("cordic_opt_fixpt27_32_c_addsub_v12_0_i0"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(55),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_opt_fixpt27_32/total32/Subsystem28bit
module cordic_opt_fixpt27_32_subsystem28bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_33279030870dd223babf4dad3e9dfa05 cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_opt_fixpt27_32_xlmult #(
    ...
    .c_output_width(56),
    .c_type(0),
    .core_name0("cordic_opt_fixpt27_32_mult_gen_v12_0_i1"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_opt_fixpt27_32_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(57),
    .core_name0("cordic_opt_fixpt27_32_c_addsub_v12_0_i1"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(57),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_opt_fixpt27_32/total32/Subsystem29bit
module cordic_opt_fixpt27_32_subsystem29bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_388215c05cc2e8314bbcac4e06dbde9c cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_opt_fixpt27_32_xlmult #(
    ...
    .c_output_width(58),
    .c_type(0),
    .core_name0("cordic_opt_fixpt27_32_mult_gen_v12_0_i2"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_opt_fixpt27_32_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(59),
    .core_name0("cordic_opt_fixpt27_32_c_addsub_v12_0_i2"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(59),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_opt_fixpt27_32/total32/Subsystem30bit
module cordic_opt_fixpt27_32_subsystem30bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_b34c20e9e30e4e9be65ff66d02b9129f cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_opt_fixpt27_32_xlmult #(
    ...
    .c_output_width(60),
    .c_type(0),
    .core_name0("cordic_opt_fixpt27_32_mult_gen_v12_0_i3"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_opt_fixpt27_32_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(61),
    .core_name0("cordic_opt_fixpt27_32_c_addsub_v12_0_i3"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(61),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_opt_fixpt27_32/total32/Subsystem31bit
module cordic_opt_fixpt27_32_subsystem31bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_5a17693387bce44d203a5619b2f3c756 cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_opt_fixpt27_32_xlmult #(
    ...
    .c_output_width(62),
    .c_type(0),
    .core_name0("cordic_opt_fixpt27_32_mult_gen_v12_0_i4"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_opt_fixpt27_32_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(63),
    .core_name0("cordic_opt_fixpt27_32_c_addsub_v12_0_i4"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(63),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_opt_fixpt27_32/total32/Subsystem32bit
module cordic_opt_fixpt27_32_subsystem32bit (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  xlcordic_a46629ef57ede14a744e686dbf4f2eb0 cordic16 (
    .s_axis_cartesian_tvalid(constant_op_net),
    .s_axis_cartesian_tdata_real(addsub1_s_net),
    .clk(clk_net),
    .ce(ce_net),
  ...
  cordic_opt_fixpt27_32_xlmult #(
    ...
    .c_output_width(64),
    .c_type(0),
    .core_name0("cordic_opt_fixpt27_32_mult_gen_v12_0_i5"),
    .extra_registers(0),
    .multsign(2),
    .overflow(1),
    .p_arith(`xlSigned),
  ...
  cordic_opt_fixpt27_32_xladdsub #(
    ...
    .c_latency(0),
    .c_output_width(65),
    .core_name0("cordic_opt_fixpt27_32_c_addsub_v12_0_i5"),
    .extra_registers(0),
    .full_s_arith(2),
    .full_s_width(65),
    .latency(0),
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_opt_fixpt27_32/total32
module cordic_opt_fixpt27_32_total32 (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  cordic_opt_fixpt27_32_subsystem27bit subsystem27bit (
  ...
  cordic_opt_fixpt27_32_subsystem28bit subsystem28bit (
  ...
  cordic_opt_fixpt27_32_subsystem29bit subsystem29bit (
  ...
  cordic_opt_fixpt27_32_subsystem30bit subsystem30bit (
  ...
  cordic_opt_fixpt27_32_subsystem31bit subsystem31bit (
  ...
  cordic_opt_fixpt27_32_subsystem32bit subsystem32bit (
...
`timescale 1 ns / 10 ps
// Generated from Simulink block cordic_opt_fixpt27_32_struct
module cordic_opt_fixpt27_32_struct (
  input [27-1:0] gate_in1,
  input [27-1:0] gate_in2,
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  cordic_opt_fixpt27_32_total32 total32 (
...
module cordic_opt_fixpt27_32_default_clock_driver (
  input cordic_opt_fixpt27_32_sysclk,
  input cordic_opt_fixpt27_32_sysce,
  input cordic_opt_fixpt27_32_sysclr,
  output cordic_opt_fixpt27_32_clk1,
  output cordic_opt_fixpt27_32_ce1
);
  xlclockdriver #(
    .period(1),
    .log_2_period(1)
  ...
  clockdriver (
    .sysclk(cordic_opt_fixpt27_32_sysclk),
    .sysce(cordic_opt_fixpt27_32_sysce),
    .sysclr(cordic_opt_fixpt27_32_sysclr),
    .clk(cordic_opt_fixpt27_32_clk1),
    .ce(cordic_opt_fixpt27_32_ce1)
  );
endmodule
`timescale 1 ns / 10 ps
// Generated from Simulink block 
(* core_generation_info = "cordic_opt_fixpt27_32,sysgen_core_2022_1,{,compilation=HDL Netlist,block_icon_display=Default,family=virtexuplus,part=xcu250,speed=-2L-e,package=figd2104,synthesis_language=verilog,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=50,system_simulink_period=1,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=116,addsub=6,constant=6,cordic_v6_0=6,mult=12,}" *)
module cordic_opt_fixpt27_32 (
  ...
  wire clk_1_net;
  wire ce_1_net;
  cordic_opt_fixpt27_32_default_clock_driver cordic_opt_fixpt27_32_default_clock_driver (
    .cordic_opt_fixpt27_32_sysclk(clk),
    .cordic_opt_fixpt27_32_sysce(1'b1),
    .cordic_opt_fixpt27_32_sysclr(1'b0),
    .cordic_opt_fixpt27_32_clk1(clk_1_net),
    .cordic_opt_fixpt27_32_ce1(ce_1_net)
  );
  cordic_opt_fixpt27_32_struct cordic_opt_fixpt27_32_struct (
