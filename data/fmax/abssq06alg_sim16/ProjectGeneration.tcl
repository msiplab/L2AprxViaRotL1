...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{xlclockdriver_rd.v}}
		{{vivado_ip.tcl}}
		{{abssq06_fixpt16_entity_declarations.v}}
		{{abssq06_fixpt16.v}}
		{{abssq06_fixpt16_tb.v}}
		{{abssq06_fixpt16_clock.xdc}}
		{{abssq06_fixpt16.xdc}}
	}
	set SimPeriod 1
	set SimTime 99
	...
	set TargetDir {/home/shu_abe/2tl2aprx/l2norm_FPGA_project/fmax/abssq06alg_sim16}
	set TestBenchModule {abssq06_fixpt16_tb}
	set TopLevelModule {abssq06_fixpt16}
	set TopLevelSimulinkHandle 3042.02
	...
	dict set TopLevelPortInterface gate_in2 DatFile {abssq06_fixpt16_subsystem16bitalg_gate_in2.dat}
	...
	dict set TopLevelPortInterface gate_in2 ClockDomain {abssq06_fixpt16}
	...
	dict set TopLevelPortInterface gate_in1 DatFile {abssq06_fixpt16_subsystem16bitalg_gate_in1.dat}
	...
	dict set TopLevelPortInterface gate_in1 ClockDomain {abssq06_fixpt16}
	...
	dict set TopLevelPortInterface gate_out1 DatFile {abssq06_fixpt16_subsystem16bitalg_gate_out1.dat}
	...
	dict set TopLevelPortInterface gate_out1 ClockDomain {abssq06_fixpt16}
	...
	dict set TopLevelPortInterface clk ClockDomain {abssq06_fixpt16}
