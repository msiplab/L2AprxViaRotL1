...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{xlclockdriver_rd.v}}
		{{vivado_ip.tcl}}
		{{abslut50_fixpt16_dist_mem_gen_i0_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i1_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i2_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i3_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i4_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i5_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i6_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i7_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i8_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i9_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i10_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i11_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i12_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i13_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i14_vivado.coe}}
		{{abslut50_fixpt16_dist_mem_gen_i15_vivado.coe}}
		{{abslut50_fixpt16_entity_declarations.v}}
		{{abslut50_fixpt16.v}}
		{{abslut50_fixpt16_tb.v}}
		{{abslut50_fixpt16_clock.xdc}}
		{{abslut50_fixpt16.xdc}}
	}
	set SimPeriod 1
	set SimTime 99
	...
	set TargetDir {/home/shu_abe/document/l2norm_modelcomposer/pla_lut/abslut50/abslut50_sim16}
	set TestBenchModule {abslut50_fixpt16_tb}
	set TopLevelModule {abslut50_fixpt16}
	set TopLevelSimulinkHandle 0.0106201
	...
	dict set TopLevelPortInterface gate_in2 DatFile {abslut50_fixpt16_subsystem16bit_gate_in2.dat}
	...
	dict set TopLevelPortInterface gate_in2 ClockDomain {abslut50_fixpt16}
	...
	dict set TopLevelPortInterface gate_in1 DatFile {abslut50_fixpt16_subsystem16bit_gate_in1.dat}
	...
	dict set TopLevelPortInterface gate_in1 ClockDomain {abslut50_fixpt16}
	...
	dict set TopLevelPortInterface gate_out1 DatFile {abslut50_fixpt16_subsystem16bit_gate_out1.dat}
	...
	dict set TopLevelPortInterface gate_out1 ClockDomain {abslut50_fixpt16}
	...
	dict set TopLevelPortInterface clk ClockDomain {abslut50_fixpt16}
