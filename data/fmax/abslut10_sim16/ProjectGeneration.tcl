...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{xlclockdriver_rd.v}}
		{{vivado_ip.tcl}}
		{{abslut10_fixpt16_dist_mem_gen_i0_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i1_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i2_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i3_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i4_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i5_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i6_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i7_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i8_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i9_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i10_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i11_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i12_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i13_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i14_vivado.coe}}
		{{abslut10_fixpt16_dist_mem_gen_i15_vivado.coe}}
		{{abslut10_fixpt16_entity_declarations.v}}
		{{abslut10_fixpt16.v}}
		{{abslut10_fixpt16_tb.v}}
		{{abslut10_fixpt16_clock.xdc}}
		{{abslut10_fixpt16.xdc}}
	}
	set SimPeriod 1
	set SimTime 99
	...
	set TargetDir {/home/shu_abe/document/l2norm_modelcomposer/pla_lut/abslut10/abslut10_sim16}
	set TestBenchModule {abslut10_fixpt16_tb}
	set TopLevelModule {abslut10_fixpt16}
	set TopLevelSimulinkHandle 0.0100098
	...
	dict set TopLevelPortInterface gate_in2 DatFile {abslut10_fixpt16_subsystem16bit_gate_in2.dat}
	...
	dict set TopLevelPortInterface gate_in2 ClockDomain {abslut10_fixpt16}
	...
	dict set TopLevelPortInterface gate_in1 DatFile {abslut10_fixpt16_subsystem16bit_gate_in1.dat}
	...
	dict set TopLevelPortInterface gate_in1 ClockDomain {abslut10_fixpt16}
	...
	dict set TopLevelPortInterface gate_out1 DatFile {abslut10_fixpt16_subsystem16bit_gate_out1.dat}
	...
	dict set TopLevelPortInterface gate_out1 ClockDomain {abslut10_fixpt16}
	...
	dict set TopLevelPortInterface clk ClockDomain {abslut10_fixpt16}
