...
// Generated from Simulink block abssq04_fixpt16/Subsystem16bit
module abssq04_fixpt16_subsystem16bit (
  ...
  sysgen_scale_076f19cbb0 scale2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .ip(slice2_y_net),
  ...
  sysgen_scale_537c243c5d scale3 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .ip(slice3_y_net),
  ...
  sysgen_relational_c070d1b267 bool1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .a(scale3_op_net),
...
module abssq04_fixpt16_struct (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  abssq04_fixpt16_subsystem16bit subsystem16bit (
