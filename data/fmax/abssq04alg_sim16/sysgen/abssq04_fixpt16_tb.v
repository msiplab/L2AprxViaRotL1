...
module abssq04_fixpt16_tb (
  ...
  xltbsource #(
    ...
    .o_bin_pt(14),
    .o_width(16),
    .inputFile("abssq04_fixpt16_subsystem16bitalg_gate_in1.dat"),
    .periodMultiplier(1)
  )
  gate_in1_driver (
    .clk(clk_net),
  ...
  xltbsource #(
    ...
    .o_bin_pt(14),
    .o_width(16),
    .inputFile("abssq04_fixpt16_subsystem16bitalg_gate_in2.dat"),
    .periodMultiplier(1)
  )
  gate_in2_driver (
    .clk(clk_net),
  ...
  xltbsink #(
    ...
    .i_bin_pt(15),
    .i_width(16),
    .inputFile("abssq04_fixpt16_subsystem16bitalg_gate_out1.dat"),
    .periodMultiplier(1)
  )
  gate_out1_load (
    .i(gate_out1_net),
