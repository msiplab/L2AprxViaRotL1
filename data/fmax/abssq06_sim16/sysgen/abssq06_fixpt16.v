...
// Generated from Simulink block abssq06_fixpt16/Subsystem16bit
module abssq06_fixpt16_subsystem16bit (
  ...
  sysgen_scale_a64a64f960 scale2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .ip(slice2_y_net),
  ...
  sysgen_scale_3b5bbee74a scale4 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .ip(slice4_y_net),
  ...
  sysgen_relational_873b7c22ab bool1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .a(scale3_op_net),
...
module abssq06_fixpt16_struct (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  abssq06_fixpt16_subsystem16bit subsystem16bit (
