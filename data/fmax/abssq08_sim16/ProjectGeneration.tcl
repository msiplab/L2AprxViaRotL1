...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{xlclockdriver_rd.v}}
		{{vivado_ip.tcl}}
		{{abssq08_fixpt16_entity_declarations.v}}
		{{abssq08_fixpt16.v}}
		{{abssq08_fixpt16_tb.v}}
		{{abssq08_fixpt16_clock.xdc}}
		{{abssq08_fixpt16.xdc}}
	}
	set SimPeriod 1
	set SimTime 99
	...
	set TargetDir {/home/shu_abe/document/l2norm_modelcomposer/abssq/abssq08/abssq08_sim16}
	set TestBenchModule {abssq08_fixpt16_tb}
	set TopLevelModule {abssq08_fixpt16}
	set TopLevelSimulinkHandle 0.0045166
	...
	dict set TopLevelPortInterface gate_in2 DatFile {abssq08_fixpt16_subsystem16bit_gate_in2.dat}
	...
	dict set TopLevelPortInterface gate_in2 ClockDomain {abssq08_fixpt16}
	...
	dict set TopLevelPortInterface gate_in1 DatFile {abssq08_fixpt16_subsystem16bit_gate_in1.dat}
	...
	dict set TopLevelPortInterface gate_in1 ClockDomain {abssq08_fixpt16}
	...
	dict set TopLevelPortInterface gate_out1 DatFile {abssq08_fixpt16_subsystem16bit_gate_out1.dat}
	...
	dict set TopLevelPortInterface gate_out1 ClockDomain {abssq08_fixpt16}
	...
	dict set TopLevelPortInterface clk ClockDomain {abssq08_fixpt16}
