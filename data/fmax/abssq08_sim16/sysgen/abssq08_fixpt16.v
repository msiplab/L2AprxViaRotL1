...
// Generated from Simulink block abssq08_fixpt16/Subsystem16bit
module abssq08_fixpt16_subsystem16bit (
  ...
  sysgen_scale_701761b107 scale2 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .ip(slice2_y_net),
  ...
  sysgen_scale_64216187a0 scale5 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .ip(slice5_y_net),
  ...
  sysgen_relational_1c91765336 bool1 (
    .clk(1'b0),
    .ce(1'b0),
    .clr(1'b0),
    .a(scale3_op_net),
...
module abssq08_fixpt16_struct (
  ...
  assign clk_net = clk_1;
  assign ce_net = ce_1;
  abssq08_fixpt16_subsystem16bit subsystem16bit (
