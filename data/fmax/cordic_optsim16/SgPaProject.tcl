namespace eval ::xilinx::dsp::planaheadworker {
   ...
   proc dsp_add_project_files {} {
      ...
      # This below code sets all the .vhd files type to VHDL2008 based on the set param 
      # i.e. VHDL2008Support available in ProjectGeneration.tcl file
      set enableHDL2008Support [dsp_get_param_value_in_driver_tcl_namespace VHDL2008Support ]
      
      if {$enableHDL2008Support == 1} {
	 set vhd_files [get_files *vhd]
         foreach vhdfile $vhd_files {
            set_property file_type {VHDL 2008} $vhdfile
         }
      }
...
<Description>A description for this file collection</Description>}
 ...
 proc dsp_ipp_handler_vhd { filelist } {
     ...
     foreach ffile $filelist {    
         ...
         set_property LIBRARY_NAME $library [ipx::add_file "hdl/[file tail $ffile]" [dsp_ipp_get_synthesis_file_group]]
         if {$enableHDL2008Support == 1} {
             # Top Level Module should not be set as VHDL 2008 as per ug1118  
             if { [string equal [file tail [file rootname $ffile]] $top_module] == 0 } {
                 set_property type vhdlSource-2008 [ipx::get_files "hdl/[file tail $ffile]" -of_objects [dsp_ipp_get_synthesis_file_group]]
             }
         }
         set_property LIBRARY_NAME $library [ipx::add_file "hdl/[file tail $ffile]" [dsp_ipp_get_simulation_file_group]]
         if {$enableHDL2008Support == 1} {
             # Top Level Module should not be set as VHDL 2008 as per ug1118
             if { [string equal [file tail [file rootname $ffile]] $top_module] == 0 } {
                 set_property type vhdlSource-2008 [ipx::get_files "hdl/[file tail $ffile]" -of_objects [dsp_ipp_get_simulation_file_group]]
             }
         }
         lappend ordered_file_list $ffile
         if { $top_module_file == [file tail $ffile] } {
