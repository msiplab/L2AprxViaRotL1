...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set Project {cordic_max_fixpt16}
	set ProjectFiles {
		{{conv_pkg.v}}
		{{synth_reg.v}}
		{{synth_reg_w_init.v}}
		...
		{{xlclockdriver_rd.v}}
		{{vivado_ip.tcl}}
		{{cordic_max_fixpt16_entity_declarations.v}}
		{{cordic_max_fixpt16.v}}
		{{cordic_max_fixpt16_tb.v}}
		{{cordic_max_fixpt16_clock.xdc}}
		{{cordic_max_fixpt16.xdc}}
	}
	set SimPeriod 1
	set SimTime 116
	...
	set TargetDir {/home/shu_abe/document/l2norm_modelcomposer/cordic/maximum/cordic_maxsim16}
	set TestBenchModule {cordic_max_fixpt16_tb}
	set TopLevelModule {cordic_max_fixpt16}
	set TopLevelSimulinkHandle 0.0111084
	...
	dict set TopLevelPortInterface gate_in2 DatFile {cordic_max_fixpt16_subsystem16bit_gate_in2.dat}
	...
	dict set TopLevelPortInterface gate_in2 ClockDomain {cordic_max_fixpt16}
	...
	dict set TopLevelPortInterface gate_in1 DatFile {cordic_max_fixpt16_subsystem16bit_gate_in1.dat}
	...
	dict set TopLevelPortInterface gate_in1 ClockDomain {cordic_max_fixpt16}
	...
	dict set TopLevelPortInterface gate_out1 DatFile {cordic_max_fixpt16_subsystem16bit_gate_out1.dat}
	...
	dict set TopLevelPortInterface gate_out1 ClockDomain {cordic_max_fixpt16}
	...
	dict set TopLevelPortInterface clk ClockDomain {cordic_max_fixpt16}
