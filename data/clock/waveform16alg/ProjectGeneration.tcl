...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set TargetDir {/home/shu_abe/2tl2aprx/l2norm_FPGA_project/clock/waveform16alg}
	set TestBenchModule {waveform_tb}
	set TopLevelModule {waveform}
	set TopLevelSimulinkHandle 0.00610352
	...
	dict set TopLevelPortInterface gate_in2_x6 DatFile {waveform_proposal_sq08_gate_in2.dat}
	dict set TopLevelPortInterface gate_in2_x6 IconText {waveform/proposal_sq08/Gate_In2}
	...
	dict set TopLevelPortInterface gate_in1_x5 DatFile {waveform_proposal_sq08_gate_in1.dat}
	dict set TopLevelPortInterface gate_in1_x5 IconText {waveform/proposal_sq08/Gate_In1}
	...
	dict set TopLevelPortInterface gate_in2_x5 DatFile {waveform_proposal_sq06_gate_in2.dat}
	dict set TopLevelPortInterface gate_in2_x5 IconText {waveform/proposal_sq06/Gate_In2}
	...
	dict set TopLevelPortInterface gate_in1_x4 DatFile {waveform_proposal_sq06_gate_in1.dat}
	dict set TopLevelPortInterface gate_in1_x4 IconText {waveform/proposal_sq06/Gate_In1}
	...
	dict set TopLevelPortInterface gate_in2_x4 DatFile {waveform_proposal_sq04_gate_in2.dat}
	dict set TopLevelPortInterface gate_in2_x4 IconText {waveform/proposal_sq04/Gate_In2}
	...
	dict set TopLevelPortInterface gate_in1_x3 DatFile {waveform_proposal_sq04_gate_in1.dat}
	dict set TopLevelPortInterface gate_in1_x3 IconText {waveform/proposal_sq04/Gate_In1}
	...
	dict set TopLevelPortInterface gate_out1 DatFile {waveform_proposal_sq04_gate_out1.dat}
	dict set TopLevelPortInterface gate_out1 IconText {waveform/proposal_sq04/Gate_out1}
	...
	dict set TopLevelPortInterface gate_out1 ClockDomain {waveform}
	...
	dict set TopLevelPortInterface gate_out1_x0 Type UFix_16_15
	dict set TopLevelPortInterface gate_out1_x0 ArithmeticType xlUnsigned
	dict set TopLevelPortInterface gate_out1_x0 BinaryPoint 15
	dict set TopLevelPortInterface gate_out1_x0 Width 16
	dict set TopLevelPortInterface gate_out1_x0 DatFile {waveform_proposal_sq06_gate_out1.dat}
	dict set TopLevelPortInterface gate_out1_x0 IconText {waveform/proposal_sq06/Gate_out1}
	...
	dict set TopLevelPortInterface gate_out1_x0 ClockDomain {waveform}
	...
	dict set TopLevelPortInterface gate_out1_x1 Type UFix_16_15
	dict set TopLevelPortInterface gate_out1_x1 ArithmeticType xlUnsigned
	dict set TopLevelPortInterface gate_out1_x1 BinaryPoint 15
	dict set TopLevelPortInterface gate_out1_x1 Width 16
	dict set TopLevelPortInterface gate_out1_x1 DatFile {waveform_proposal_sq08_gate_out1.dat}
	dict set TopLevelPortInterface gate_out1_x1 IconText {waveform/proposal_sq08/Gate_out1}
	...
	dict set TopLevelPortInterface gate_out1_x1 ClockDomain {waveform}
