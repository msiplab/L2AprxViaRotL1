...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set TargetDir {/home/shu_abe/document/l2norm_modelcomposer/pla_lut/abslut50/abslut50_fixpt10}
	...
	dict set TopLevelPortInterface gate_in2 Type Fix_10_8
	dict set TopLevelPortInterface gate_in2 ArithmeticType xlSigned
	dict set TopLevelPortInterface gate_in2 BinaryPoint 8
	dict set TopLevelPortInterface gate_in2 Width 10
	dict set TopLevelPortInterface gate_in2 DatFile {abslut50_fixpt8_19_total19_subsystem10bit_gate_in2.dat}
	...
	dict set TopLevelPortInterface gate_in1 Type Fix_10_8
	dict set TopLevelPortInterface gate_in1 ArithmeticType xlSigned
	dict set TopLevelPortInterface gate_in1 BinaryPoint 8
	dict set TopLevelPortInterface gate_in1 Width 10
	dict set TopLevelPortInterface gate_in1 DatFile {abslut50_fixpt8_19_total19_subsystem10bit_gate_in1.dat}
	...
	dict set TopLevelPortInterface gate_out1 Type UFix_10_9
	dict set TopLevelPortInterface gate_out1 ArithmeticType xlUnsigned
	dict set TopLevelPortInterface gate_out1 BinaryPoint 9
	dict set TopLevelPortInterface gate_out1 Width 10
	dict set TopLevelPortInterface gate_out1 DatFile {abslut50_fixpt8_19_total19_subsystem10bit_gate_out1.dat}
