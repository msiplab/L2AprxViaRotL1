...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{abslut50_fixpt20_32_dist_mem_gen_i30_vivado.coe}}
		{{abslut50_fixpt20_32_dist_mem_gen_i31_vivado.coe}}
	...
	set TargetDir {/home/shu_abe/document/l2norm_modelcomposer/pla_lut/abslut50/abslut50_fixpt32}
	...
	dict set TopLevelPortInterface gate_in2 Type Fix_32_30
	dict set TopLevelPortInterface gate_in2 ArithmeticType xlSigned
	dict set TopLevelPortInterface gate_in2 BinaryPoint 30
	dict set TopLevelPortInterface gate_in2 Width 32
	dict set TopLevelPortInterface gate_in2 DatFile {abslut50_fixpt20_32_total32_subsystem32bit_gate_in2.dat}
	...
	dict set TopLevelPortInterface gate_in1 Type Fix_32_30
	dict set TopLevelPortInterface gate_in1 ArithmeticType xlSigned
	dict set TopLevelPortInterface gate_in1 BinaryPoint 30
	dict set TopLevelPortInterface gate_in1 Width 32
	dict set TopLevelPortInterface gate_in1 DatFile {abslut50_fixpt20_32_total32_subsystem32bit_gate_in1.dat}
	...
	dict set TopLevelPortInterface gate_out1 Type UFix_32_31
	dict set TopLevelPortInterface gate_out1 ArithmeticType xlUnsigned
	dict set TopLevelPortInterface gate_out1 BinaryPoint 31
	dict set TopLevelPortInterface gate_out1 Width 32
	dict set TopLevelPortInterface gate_out1 DatFile {abslut50_fixpt20_32_total32_subsystem32bit_gate_out1.dat}
