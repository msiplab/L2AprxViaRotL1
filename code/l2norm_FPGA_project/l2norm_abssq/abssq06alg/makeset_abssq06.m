%% model name
for k = 8:32
    sys = "abssq06alg_fixpt8_32/total32/Subsystem"+num2str(k)+"bit";
    ...
    set_param(sys+"/Slice3", 'nbits', num2str(k))
    set_param(sys+"/Slice3", 'mode', 'Upper Bit Location + Width')
    set_param(sys+"/Slice3", 'bit1', '-4')
