%% model name
for i = 20:32
%     sys = "cordic_nop_fixpt8_19/total19/Subsystem"+num2str(i)+"bit";
    sys = "cordic_nop_fixpt20_32/total32/Subsystem"+num2str(i)+"bit";
%     sys = 'cordic_nop_16/Subsystem16bit';
    ...
    set_param(sys+"/CORDIC16", 'pipelining_mode', 'No_Pipelining')
...
%             s = get(out,char(fin(j))).signals.values(2:101);
%             me(i-7) = sum(s)/100;
%         end
%     end
% end
...
%% ketugou
cord_nop = [cord_nop8_19,cord_nop20_32];
